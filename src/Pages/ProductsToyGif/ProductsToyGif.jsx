...
import './ProductsToyGif.css'
import ProductDetailCard from '../../Components/ProductDetailCard/ProductDetailCard';
import { Link } from 'react-router-dom';
import { ProductsDataToyGif } from "../../ProductsDataToyGif";

const ProductsToyGif  = () => {
    return (
      <div className='Products'>
        <div className='Products-Filters'>
          ...
          <div className='Category'>
            ...
            <div className='filter-category'>Toys and Gift Items</div>
          </div>
          <div className='Price'>
        ...
        <div className='Products-items'>
          <p className='totalresults'>
            Showing 1-{ProductsDataToyGif.length} of {ProductsDataToyGif.length} results
          </p>
        <div>
          {ProductsDataToyGif.map((item,index)=> (
            <Link key={index} to={`/productdetailstoygif/${item.id}`}>
