...
import './ProductsBeauty.css'
import ProductDetailCard from '../../Components/ProductDetailCard/ProductDetailCard';
import { Link } from 'react-router-dom';
import { ProductsDataBeauty } from "../../ProductsDataBeauty";
      ...
      <div className='Products'>
        ...
        <div className='Products-items'>
          <p className='totalresults'>
            Showing 1-{ProductsDataBeauty.length} of {ProductsDataBeauty.length} results
          </p>
        <div>
          {ProductsDataBeauty.map((item,index)=> (
            <Link key={index} to={`/productdetailsbeauty/${item.id}`}>
